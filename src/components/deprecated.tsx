...
export default function D() {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden w-full bg-primary p-6 flex border-b-[4px] shadow-xl border-secondary-shadow items-center justify-content
      ...
      <div 
        className="flex flex-wrap justify-center gap-9
          after:h-full after:w-[1rem] after:border-l-[3px] after:border-dashed after:border-secondary-shadow after:left-[1.9rem] after:top-[7.9rem] after:absolute">
        {projects.map((p) => (
          <Card
            img={p.image}
            title={p.title}
  ...
  return (
    <article
      className="max-h-[26rem] max-w-[19.2rem] flex relative flex-col gap-[1.25rem] ml-[3.7rem] rounded 
        ...
        after:h-[6px] after:w-20 after:absolute after:border-dashed after:border-t-[3px] after:border-secondary-shadow after:top-[51%] after:left-[0%]
