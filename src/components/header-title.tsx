function HeaderTitle({ children }) {
  return (
    <header
      className="justify-content relative flex w-full items-center overflow-hidden rounded rounded-t-sm border-b-[7px] border-secondary-shadow bg-primary px-[1.45rem] py-6 
