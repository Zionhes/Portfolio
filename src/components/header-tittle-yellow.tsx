function HeaderTitleYellow({
  ...
  return (
    <header
      className={`justify-content ${height} shadow-1 relative flex w-full items-center overflow-hidden rounded-lg rounded-t border-b-[0.45rem] border-yellow-600 bg-primary px-[1.45rem] py-6
        ...
        lg:h-20 lg:gap-5 lg:rounded-xl lg:border-b-8 lg:py-5`}
    >
      {children}
    </header>
  );
